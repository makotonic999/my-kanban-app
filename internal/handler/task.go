...
func (h *TaskHandler) List(w http.ResponseWriter, r *http.Request) {
	rows, err := h.DB.Query(`SELECT id, user_id, title, description, status, due_date, estimated_minutes, actual_minutes, completed_at, created_at, updated_at FROM tasks ORDER BY created_at DESC`)
	if err != nil {
